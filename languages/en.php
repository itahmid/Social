 ...
 */
	...
	'PluginException:MisconfiguredPlugin' => "%s (guid: %s) is a misconfigured plugin. It has been disabled. Please search the Elgg wiki for possible causes (http://docs.10.10.11.201:8081/social/wiki/).",
	...
	'ElggPlugin:Dependencies:Elgg' => 'version',
	...
	'SecurityException:ForwardFailedToRedirect' => 'Redirect could not be issued due to headers already being sent. Halting execution for security. Output started in file %s at line %d. Search http://docs.10.10.11.201:8081/social/ for more information.',
 ...
 */
	...
	'admin:widget:admin_welcome:help' => "A short introduction to Social's admin area",
	'admin:widget:admin_welcome:intro' =>
'Welcome to Social! Right now you are looking at the administration dashboard. It\'s useful for tracking what\'s happening on the site.',
...
. " three sections:
	...
	// argh, this is ugly
	'admin:widget:admin_welcome:outro' => '<br />Be sure to check out the resources available through the footer links and thank you for using Social!',
	...
	'admin:footer:community_forums' => 'Community Forums',
	'admin:footer:blog' => 'Blog',
 ...
 */
	...
	'admin:plugins:warning:elgg_version_unknown' => 'This plugin uses a legacy manifest file and does not specify a compatible Social version. It probably will not work!',
	'admin:plugins:warning:unmet_dependencies' => 'This plugin has unmet dependencies and cannot be activated. Check dependencies under more info.',
	'admin:plugins:warning:invalid' => 'This plugin is invalid: %s',
	'admin:plugins:warning:invalid:check_docs' => 'Check documentation for troubleshooting tips.',
 ...
 */
	...
	'installation:path' => "The full path of the installation:",
	'installation:dataroot' => "The full path of the data directory:",
	'installation:dataroot:warning' => "You must create this directory manually. It should be in a different directory to your Social installation.",
	...
	'installation:disableapi' => "It provides an API for building web services so that remote applications can interact with your site.",
	'installation:disableapi:label' => "Enable Social web services API",
	...
	'installation:systemcache:description' => "The system cache decreases the loading time of the social engine by caching data to files.",
	'installation:systemcache:label' => "Use system cache (recommended)",

	'upgrading' => 'Upgrading...',
	'upgrade:db' => 'Your database was upgraded.',
	'upgrade:core' => 'Your installation was upgraded.',
	...
	'upgrade:unable_to_upgrade_info' =>
		...
		were detected in the core views directory. These views have been deprecated and need to be
		removed for to function correctly. If you have not made changes to core, you can
		simply delete the views directory and replace it with the one from the latest
		package of downloaded from <a href="http://10.10.11.201:8081/social/">Social</a>.<br /><br />

		If you need detailed instructions, please visit the <a href="#">
		Upgrading documentation</a>.  If you require assistance, please post to the
		<a href="#">Community Support Forums</a>.',
