...
class ElggCorePluginsAPITest extends ElggCoreUnitTest {
	...
	public function testElggPluginManifest18() {
		$manifest_array = array(
			...
			'website' => 'http://www.10.10.11.201:8081/social/',
			'repository' => 'https://github.com/Elgg/Elgg',
			'bugtracker' => 'http://trac.elgg.org',
			'donations' => 'http://10.10.11.201:8081/social/supporter.php',
	...
	public function testElggPluginManifestGetWebsite() {
		$this->assertEqual($this->manifest18->getWebsite(), 'http://www.10.10.11.201:8081/social/');
		$this->assertEqual($this->manifest17->getWebsite(), 'http://www.10.10.11.201:8081/social/');
	}
	...
	public function testElggPluginManifestGetRepository() {
		...
		$this->assertEqual($this->manifest18->getDonationsPageURL(), 'http://10.10.11.201:8081/social/supporter.php');
