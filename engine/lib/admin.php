 ...
 *
 * Used in conjuction with http://10.10.11.201:8081/social/admin/section_id/child_section style
...
function admin_pagesetup() {
	if (elgg_in_context('admin')) {
		...
		elgg_register_menu_item('admin_footer', array(
			...
			'href' => 'http://docs.10.10.11.201:8081/social/wiki/Category:Administration_FAQ',
		));

		elgg_register_menu_item('admin_footer', array(
			'name' => 'manual',
			'text' => elgg_echo('admin:footer:manual'),
			'href' => 'http://docs.10.10.11.201:8081/social/wiki/Administration_Manual',
		));

		elgg_register_menu_item('admin_footer', array(
			'name' => 'community_forums',
			'text' => elgg_echo('admin:footer:community_forums'),
			'href' => 'http://community.10.10.11.201:8081/social/groups/all/',
		));

		elgg_register_menu_item('admin_footer', array(
			'name' => 'blog',
			'text' => elgg_echo('admin:footer:blog'),
			'href' => 'http://blog.10.10.11.201:8081/social/',
		));
	}
}
