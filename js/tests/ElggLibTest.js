...
ElggLibTest.prototype.testNormalizeUrl = function() {
	elgg.config.wwwroot = "http://10.10.11.201:8081/social//";
...
ElggLibTest.prototype.testParseUrl = function() {
	...
	[
		["http://www.10.10.11.201:8081/social/test/", {'scheme': 'http', 'host': 'www.elgg.org', 'path': '/test/'}],
		["https://www.10.10.11.201:8081/social/test/", {'scheme': 'https', 'host': 'www.elgg.org', 'path': '/test/'}],
		["ftp://www.10.10.11.201:8081/social/test/", {'scheme': 'ftp', 'host': 'www.elgg.org', 'path': '/test/'}],
		["http://10.10.11.201:8081/social/test?val1=one&val2=two", {'scheme': 'http', 'host': 'elgg.org', 'path': '/test', 'query': 'val1=one&val2=two'}],
		["http://elgg.org:8080/", {'scheme': 'http', 'host': 'elgg.org', 'port': 8080, 'path': '/'}],
		["http://10.10.11.201:8081/social/test#there", {'scheme': 'http', 'host': 'elgg.org', 'path': '/test', 'fragment': 'there'}],
